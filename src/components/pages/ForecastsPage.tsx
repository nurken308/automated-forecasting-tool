...
export function ForecastsPage() {
  ...
  const handleBuildForecast = (data: any) => {
    const macroText = data.useMacrofactors ? 'с макрофакторами' : 'без макрофакторов';
  ...
  return (
    <div className="space-y-6">
      ...
      <SavedForecasts onViewDetails={handleViewForecast} />
